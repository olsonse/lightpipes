...
/** \page cpp C++ Interface

    This is the initial skeleton of documentation.
    
    Make sure you have first read \ref intro "the introduction".
*/

/** \page octave Octave Interface
...
/** \page cmdline Command-line Interface

    This is the initial skeleton of documentation.  In this section, I
    describe the command-line interface to LightPipes.  This interface should
    be very compatible with the initial c-code. 
