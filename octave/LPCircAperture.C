...
DEFUN_DLD (LPCircAperture, args, nargout,
"LPCircAperture\n"
"****************************************************\n"
"\n"
"	LightPipes for Octave Optical Toolbox\n"
"\n"
"	LPCircAperture apertures the field with a circular aperture.\n"
"\n"
"	USAGE:\n"
"	Fout = LPCircAperture(r,x0,y0,Fin);\n"
"\n"
"	with:\n"
...
"*****************************************************\n"
    ...
    field->circular_aperture(r, x0, y0);
