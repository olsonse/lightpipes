...
DEFUN_DLD (LPSuperGaussScreen, args, nargout,
"LPSuperGaussScreen\n"
"****************************************************************************************************\n"
"\n"
"	LightPipes for Octave Optical Toolbox\n"
"\n"
"	LPSuperGaussScreen screens the field with a Super-Gaussian screen.\n"
"	Fout = Fin * sqrt( 1- (1-T) * exp(-(r/w)^2n) )\n"
"\n"
"	USAGE:\n"
"	Fout=LPSuperGaussScreen(w,n,x0,y0,T,Fin);\n"
"\n"
"	with:\n"
...
"****************************************************************************************************\n"
    ...
    if (args.length() != 6 ||
        ...
        print_usage("LPSuperGaussScreen");
        return octave_value();
    }
    ...
    double R   = args(4).double_value();
    Field * field = mapToField( args(5).map_value() );
    field->supergaussian_screen(w, n, x0, y0, R);
