...
DEFUN_DLD (LPRectScreen, args, nargout,
"  LPRectScreen\n"
"****************************************************************************************************\n"
"\n"
"	LightPipes for Octave Optical Toolbox\n"
"\n"
"	LPRectScreen screens the field with a rectangular screen.\n"
"\n"
"	USAGE:\n"
"	Fout=LPRectScreen(w,h,x0,y0,Phi,Fin);\n"
"\n"
"	with:\n"
...
"****************************************************************************************************\n"
    ...
    field->rectangular_screen(w, h, x0, y0, phi);
