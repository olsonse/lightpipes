...
DEFUN_DLD (LPLensForvard, args, nargout,
" LPLensForvard\n"
"*****************************************************\n"
"\n"
"	LightPipes for Octave Optical Toolbox\n"
"\n"
"	LPLensForvard propagates the field in spherical coordinates using the FFT method.\n"
"\n"
"	USAGE:\n"
"	Fout = LPLensForvard(f,z,Fin);\n"
"\n"
"	with:\n"
