...
F6 = propagate(75.*cm, 5*cm,               F5,0,0,4,256);
printf('first lens\n'); fflush(stdout);
F7 = LPLens(-75*cm, 0, 0,                       F6);
F8 = propagate(100.*cm, 5*cm,               F7,0,0,4,256);
printf('second lens\n'); fflush(stdout);
F9 = LPLens(-25*cm, 0, 0,                       F8);
F10= propagate(25.*cm, 1*cm,               F9,0,0,4,256);
keyboard
        printf('applying slm\n'); fflush(stdout);
F10.F .*= lg;
F11 = propagate(50.*cm,2*cm,                F10,0,0,4,256);
